...
def main():
    ...
    with open(".\\src\\globals.h", mode="w", encoding="utf-8") as output:
        ...
        output.write("/**\n")
        output.write(" * @file globals.h\n")
        output.write(" * @author Chun Ho Chan\n")
        output.write(" * @brief This header file (selectively) includes all the Godot class headers provided by GDExtension.\n")
        output.write(" * Automatically generated by \"generate_globals_h.py\".\n")
        output.write(" * \n")
        output.write(" */\n")
        output.write("\n")
